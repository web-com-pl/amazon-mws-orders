 ...
 */
 ...
 class ListOrderItemsResponse extends AmazonModelAbstract {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListOrderItemsResult' => array('FieldValue' => null, 'FieldType' => 'Model\ListOrderItemsResult'),
     ...
     *
     * @return boolean TRUE if ListOrderItemsResult is set.
     */
