 ...
 */
abstract class AmazonModelAbstract
{
    ...
    */
    ...
    protected function _toXMLFragment()
    {
        ...
        foreach ($this->_fields as $fieldName => $field) {
            ...
            if (!is_null($fieldValue) && $field['FieldType'] != "Model_ResponseHeaderMetadata") {
                $fieldType = $field['FieldType'];
                if (is_array($fieldType)) {
                    if ($fieldType[0] == "object") {
    ...
    *
    * @param mixed $var
    * @return boolean TRUE if passed variable is DOMElement
    */
    ...
    *
    * @param mixed $var
    * @return boolean TRUE if passed variable is an numeric array
    */
