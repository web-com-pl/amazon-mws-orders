 ...
 * </ul>
 */
class GetCompetitivePricingForSKUResponse extends AmazonModelAbstract
{

    public function __construct($data = null)
    {
        $this->_fields = array(
            'GetCompetitivePricingForSKUResult' => array('FieldValue' => array(), 'FieldType' => array('Model\GetCompetitivePricingForSKUResult')),
