 ...
 * </ul>
 */
class GetMatchingProductForIdResponse extends AmazonModelAbstract
{

    public function __construct($data = null)
    {
        $this->_fields = array(
            'GetMatchingProductForIdResult' => array('FieldValue' => array(), 'FieldType' => array('Model\GetMatchingProductForIdResult')),
