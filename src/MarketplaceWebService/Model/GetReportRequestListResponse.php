 ...
 * </ul>
 */ 
class GetReportRequestListResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportRequestListResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportRequestListResult'),
