 ...
 * </ul>
 */
class CancelReportRequestsResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'CancelReportRequestsResult' => array('FieldValue' => null, 'FieldType' => 'Model\CancelReportRequestsResult'),
