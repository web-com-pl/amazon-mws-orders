 ...
 * </ul>
 */ 
class GetReportScheduleCountResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportScheduleCountResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportScheduleCountResult'),
