 ...
 * </ul>
 */ 
class GetFeedSubmissionListResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetFeedSubmissionListResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetFeedSubmissionListResult'),
