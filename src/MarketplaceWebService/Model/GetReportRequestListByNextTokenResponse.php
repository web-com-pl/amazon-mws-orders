 ...
 * </ul>
 */ 
class GetReportRequestListByNextTokenResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportRequestListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportRequestListByNextTokenResult'),
