 ...
 * </ul>
 */ 
class GetReportScheduleListResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportScheduleListResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportScheduleListResult'),
