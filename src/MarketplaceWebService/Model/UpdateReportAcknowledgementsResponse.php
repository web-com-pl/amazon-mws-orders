 ...
 * </ul>
 */ 
class UpdateReportAcknowledgementsResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'UpdateReportAcknowledgementsResult' => array('FieldValue' => null, 'FieldType' => 'Model\UpdateReportAcknowledgementsResult'),
