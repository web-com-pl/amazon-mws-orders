 ...
 * </ul>
 */ 
class GetReportListByNextTokenResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportListByNextTokenResult'),
