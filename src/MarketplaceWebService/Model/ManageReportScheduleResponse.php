 ...
 * </ul>
 */ 
class ManageReportScheduleResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'ManageReportScheduleResult' => array('FieldValue' => null, 'FieldType' => 'Model\ManageReportScheduleResult'),
