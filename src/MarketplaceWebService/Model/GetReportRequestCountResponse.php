 ...
 * </ul>
 */ 
class GetReportRequestCountResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'GetReportRequestCountResult' => array('FieldValue' => null, 'FieldType' => 'Model\GetReportRequestCountResult'),
