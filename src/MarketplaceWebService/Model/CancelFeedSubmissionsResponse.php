 ...
 * </ul>
 */
class CancelFeedSubmissionsResponse extends AmazonModelAbstract
{
    ...
    {
        $this->fields = array (
        'CancelFeedSubmissionsResult' => array('FieldValue' => null, 'FieldType' => 'Model\CancelFeedSubmissionsResult'),
